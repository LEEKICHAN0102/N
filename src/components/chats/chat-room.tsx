...
export default function ChatRoom() {
  return(
    <div className="bg-amber-100 min-h-72 max-w-64 flex flex-col p-3 items-center rounded-md border-gray-400 gap-5">
      ...
      <div className="flex items-center justify-start w-64 p-3 text-gray-500 font-bold text-sm">2024-12-13</div>
